...
{
    unsafe public class Render3D
    {
        private const Int32 MaxQuadCount = 2000 * 6;
        private const Int32 MaxVertexCount = MaxQuadCount * 8;
        private const Int32 MaxIndexCount = MaxQuadCount * 6*6;
        ...
        static public void Init()
        {
            ...
            UInt32 offset = 0;
            for (int i = 0; i < MaxIndexCount; i += 6*6)
            {
                ...
                indices[i + 8] = 2 + offset;
                indices[i + 9] = 2 + offset;
                indices[i + 10] = 5 + offset;
                indices[i + 11] = 6 + offset;
                ...
                indices[i + 22] = 0 + offset;
                indices[i + 23] = 3 + offset;

                indices[i + 24] = 3 + offset;
                indices[i + 25] = 2 + offset;
                indices[i + 26] = 7 + offset;
                indices[i + 27] = 7 + offset;
                indices[i + 28] = 2 + offset;
                indices[i + 29] = 6 + offset;

                indices[i + 30] = 4 + offset;
                indices[i + 31] = 5 + offset;
                indices[i + 32] = 0 + offset;
                indices[i + 33] = 0 + offset;
                indices[i + 34] = 5 + offset;
